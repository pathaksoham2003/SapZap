    ...
    <div className="relative w-full overflow-hidden flex justify-center items-center pt-[80px]">
      ...
      <div className="relative w-full flex flex-col lg:flex-row max-w-[1240px] px-6">
        ...
        <motion.div
          ...
          transition={{ duration: 1.5, delay: 0.5 }}
          viewport={{ once: true }}
          className="invisible md:visible  flex w-full lg:w-1/2 justify-center lg:justify-end mt-10 lg:mt-0"
        >
          <img src={SAP} className="w-full max-w-[400px] lg:max-w-[500px] h-auto" />
        </motion.div>
      </div>
    </div>
  );
